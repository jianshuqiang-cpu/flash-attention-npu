...
struct FAInferTilingData {
    ...
    uint32_t get_mm1L1TileM() const { return mm1L1TileM; }
    uint32_t get_mm1L1TileN() const { return mm1L1TileN; }
    uint32_t get_mm1L1TileKLeft() const { return mm1L1TileKLeft; }
    uint32_t get_mm1L1TileKRight() const { return mm1L1TileKRight; }
    uint32_t get_mm2L1TileM() const { return mm2L1TileM; }
    uint32_t get_mm2L1TileN() const { return mm2L1TileN; }
    uint32_t get_mm2L1TileKLeft() const { return mm2L1TileKLeft; }
    uint32_t get_mm2L1TileKRight() const { return mm2L1TileKRight; }
    ...
    void set_mm1L1TileM(uint32_t value) { mm1L1TileM = value;}
    void set_mm1L1TileN(uint32_t value) { mm1L1TileN = value;}
    void set_mm1L1TileKLeft(uint32_t value) { mm1L1TileKLeft = value;}
    void set_mm1L1TileKRight(uint32_t value) { mm1L1TileKRight = value;}
    void set_mm2L1TileM(uint32_t value) { mm2L1TileM = value;}
    void set_mm2L1TileN(uint32_t value) { mm2L1TileN = value;}
    void set_mm2L1TileKLeft(uint32_t value) { mm2L1TileKLeft = value;}
    void set_mm2L1TileKRight(uint32_t value) { mm2L1TileKRight = value;}
