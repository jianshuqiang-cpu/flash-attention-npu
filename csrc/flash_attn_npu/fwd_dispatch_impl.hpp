...
//
// Shared implementation of the v2 forward FAInfer dispatch. Included by
// fwd_dispatch_bf16.cpp and fwd_dispatch_fp16.cpp, each of which explicitly
// instantiates launch_fwd_impl<DType, IS_TND> for its dtype only, so the FAInfer
